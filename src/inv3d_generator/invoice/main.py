...
def create_invoice(
    ...
    content = InvoiceContent(
        ...
        max_products=template.num_products,
        shipping_tag=template.shipment_tag,
        discount_tag=template.discount_tag,
    )
    ...
    locator.export_json(
        output_dir / "ground_truth_words.json", height=height, width=width
    )
